# Annahmen und Methodik – Data Quality Analyse: Artikelstammdaten

**Projekt:** dq_artikelstammdaten  
**Autorin:** Anna Sommani  


Dieses Dokument hält alle Annahmen, methodischen Entscheidungen und bekannten Einschränkungen der Analyse transparent fest. Wo eine Entscheidung das Ergebnis eines bestimmten KPIs oder einer Prüfung beeinflusst, wird die Begründung explizit erläutert.
...
**Nenner der Rate:** Die Vollständigkeitsrate wird als `1 - (missing / n_total)` pro Feld berechnet, und die Gesamtrate über alle Pflichtfelder hinweg als `1 - (total_missing / (n_rows x n_fields))`. 
